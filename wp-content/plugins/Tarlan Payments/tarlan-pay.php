...
class WC_Tarlan_Payments_Gateway extends WC_Payment_Gateway{
	...
	public function __construct(){
		...
		add_action('woocommerce_order_refunded' . $this->id, array($this, 'payment_refund'));
		add_action('woocommerce_order_partially_refunded' . $this->id, array($this, 'payment_refund'));
	}
